...
Op de zaakpagina (`/zaken/[id]`) staat één algemeen upload-blok ("Documenten uploaden", multi-select) — geen los knopje per checklist-item meer, want er is geen vooraf berekende checklist meer.
